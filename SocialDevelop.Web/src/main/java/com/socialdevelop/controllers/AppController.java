...
public class AppController {
 ...
 /* --------------- Start Tala -------------------- */
    ...
    public String register(@RequestParam("name") String name,
        ...
        if ("".equals(name) || "".equals(password) || "".equals(birthDate) || "".equals(surname) || "".equals(nickname) || "".equals(email) || "".equals(phoneNumber) || "".equals(gender) || "".equals(address)) {
            model.put("error", "You have to fill all the fields.");
            return "login-page";
        }
    ...
    public String viewMyProfile(ModelMap model) {
        ...
        //developer = service_user.viewMyProfile(utilities.UserSession.getUserData().getNickname());
        //Project project=service_project.viewProjectInfo(id);
        model.put("developer", developer);
        checkSession();
    ...
    public String updateMyProfile(@RequestParam("name") String name,
        ...
        Users developer = new Users(utilities.UserSession.getUserData().getIdUser(), name, address, surname, password, surname, email, phoneNumber, gender, aboutMe, birthDate);
